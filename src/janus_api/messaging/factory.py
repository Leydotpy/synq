...
from janus_api.messaging.constants import DEFAULT_PHYSICAL_ROUTE, JANUS_LOGICAL_PATTERN
...
_ENGINE_LOADERS = MappingProxyType(
    {
        ...
        "kafka": ("janus_api.messaging.engines.kafka", "KafkaEngine", 30),
    }
)
